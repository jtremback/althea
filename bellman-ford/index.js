...
let network = {
  A: { id: 'A', peers: ['B'], marginRate: 1 },
  B: { id: 'B', peers: ['A', 'C'], marginRate: 1 },
  C: { id: 'C', peers: ['B', 'D'], marginRate: 1 },
  D: { id: 'D', peers: ['C', 'E'], marginRate: 1 },
  E: { id: 'E', peers: ['D', 'F'], marginRate: 1 },
  F: { id: 'F', peers: ['E', 'G'], marginRate: 1 },
  G: { id: 'G', peers: ['E'], marginRate: 1 }
}
